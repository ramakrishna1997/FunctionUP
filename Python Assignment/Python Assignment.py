...
# k is a consonant.
word=input("Enter name the word : ").lower()
for words in word:
...
city={1:"Mumbai",2:"Delhi",3:"Hyderabad",4:"Bangalore",5:"Chennai"}
city
print(city.values())
...
r=[1,1,2,2,3,3,4,5,6,7,8,9,10,10,11,12,13,14,15,16]
s=set(r)
s
lis=list(s)
print(lis)
